...
import { getMoralEdu, modifyMoralEdu, deleteMoralEdu, addMoralEdu } from './store/actionCreator';
...
function MoralEdu(props) {
    ...
    const { getMoralEdus, MoralEduInfo, updateMoralEdus, delMoralEdus, addMoralEdus, } = props
    // 保存模态框中 表单值的状态
...
function mapDispatchToProps(dispatch) {
    return {
        ...
        updateMoralEdus(moral) { dispatch(modifyMoralEdu(moral)) },
        delMoralEdus(moral) { dispatch(deleteMoralEdu(moral)) },
        addMoralEdus(moral) { dispatch(addMoralEdu(moral)) },
    }
}
